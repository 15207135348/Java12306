...
public class API12306 {
    ...
    public static Map<String, String> getDeviceID(Session session) {
        String algID = null;
    ...
    public static String getStations(Session session) {
     ...
     * @return
     */
    public static String getBase64Image(Session session) {
        //第1步 获取校验码图片
     ...
     * @return
     */
    public static boolean checkAnswer(Session session, String answer) {
        long timestamp = System.currentTimeMillis();
     ...
     * @return 登陆的用户昵称
     */
    public static String baseLogin(Session session, String username, String password, String answer) {
     ...
     */
    public static JSONArray queryTickets(Session session, String date, String shortFrom, String shortTo, boolean useProxy) {
     ...
     * @return
     */
    public static JSONObject queryTicketPrices(Session session, String train_no, String from_station_no, String to_station_no, String seat_types, String date) {
        Map<String, String> head = new HashMap<>();
        head.put("Host", "kyfw.12306.cn");
        head.put("Accept", "*/*");
     ...
     */
    public static JSONObject getTokenAndTicket(Session session) {
     ...
     * 获取乘客人，不下单时用
     */
    public static JSONArray getPassengers(Session session) {
     ...
     * 获取乘客人，在下单时要用
     */
    public static List<Passenger> getPassengersWithToken(Session session, String token) {
     ...
     * 检查选票人信息
     */
    public static boolean checkOrderInfo(Session session, String token, String passengerTicketStr, String oldPassengerStr) {
        Object[] params = new Object[]{
                "cancel_flag",
                "bed_level_order_num",
                "passengerTicketStr",
     ...
     * @return 队列中有多少票
     */
    public static JSONObject getQueueCount(Session session, JSONObject data, String seat, String date) {
    ...
    public static boolean confirmSingleForQueue(Session session, JSONObject data, String passengerTicketStr, String oldPassengerStr) {
        JSONObject form = data.getJSONObject("ticketInfoForPassengerForm");
        JSONObject requestDTO = form.getJSONObject("queryLeftTicketRequestDTO");
        String purpose_codes = form.getString("purpose_codes");
    ...
    public static boolean resultOrderForDcQueue(Session session, String orderId, String token) {
    ...
    public static boolean checkFace(Session session, String secretStr, String seatType) {
    ...
    public static JSONObject getSuccessRate(Session session, String secretStr, String seatType) {
        String ticker = SeatType.findNo(seatType);
    ...
    public static boolean submitANOrderRequest(Session session, String secretStr, String seatType) {
        String ticker = SeatType.findNo(seatType);
        Object[] params = new Object[]{"secretList", "_json_att"};
        Object[] values = new Object[]{secretStr + "#" + ticker + "|", ""};
        List<NameValuePair> paramsList = HttpClient.getParams(params, values);
    ...
    public static JSONObject initPassengerApi(Session session) {
    ...
    public static boolean confirmHB(Session session, String passengerInfo, String jzParam, String trainNo, String seatType) {
        session.printCookie();
    ...
    public static JSONObject queryNoCompleteOrder(Session session) {
        Object[] params = new Object[]{"_json_att"};
        Object[] values = new Object[]{""};
        List<NameValuePair> paramsList = HttpClient.getParams(params, values);
