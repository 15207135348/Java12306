...
public class TicketInquirer {
    ...
    public static List<Train> getTrains(Session session, String date, String fromStation, String toStation, boolean useProxy) {
...
//            train.setSeatTypes(seatTypes);
    ...
    public static long getExpireTime(Session session, String dates, String fromStation, String toStation, String trainCodes) {
    ...
    public static TrainTicketPrice queryTrainPrice(Session session, String fromStation, String toStation, String trainCode) {
